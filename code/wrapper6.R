...
input_data_file = 'input_temp_ERHER2_withAI_Ynames_Races.csv'
...
model_type = 'race_screentreat'
model_version = 'breast_ER-HER2_6_race_testing'
...
if (grepl('Elan', getwd())) rootdir <- "C:/Users/Elan/Documents/GitHub"
